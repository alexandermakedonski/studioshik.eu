...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
            ...
            return d.version = "1.13.2", p.constructor = d, p.kill()._gc = p._forcingPlayhead = !1, p.to = function(a, b, d, e) {
                ...
                for ("string" == typeof a && (a = c.selector(a) || a), g(a) && (a = o(a)), f = f || 0, l = 0; a.length > l; l++) e.startAt && (e.startAt = m(e.startAt)), n.to(a[l], b, m(e), l * f);
                return this.add(n, h)
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(a, b) {
            ...
            var sb = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                tb = T("transform"),
                ub = R + "transform",
                ...
                yb = M.getTransform = function(a, b, c, d) {
                    ...
                    var e, f, h, i, j, k, l, m, n, o, p, q, r, s = c ? a._gsTransform || new xb : new xb,
                        ...
                        z = parseFloat(g.defaultTransformPerspective) || 0;
                    if (tb ? e = V(a, ub, b, !0) : a.currentStyle && (e = a.currentStyle.filter.match(D), e = e && 4 === e.length ? [e[0].substr(4), Number(e[2].substr(4)), Number(e[1].substr(4)), e[3].substr(4), s.x || 0, s.y || 0].join(",") : ""), e && "none" !== e && "matrix(1, 0, 0, 1, 0, 0)" !== e) {
                        for (f = (e || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], h = f.length; --h > -1;) i = Number(f[h]), f[h] = (j = i - (i |= 0)) ? (0 | j * v + (0 > j ? -.5 : .5)) / v + i : i;
                        if (16 === f.length) {
                            var A = f[8],
                                B = f[9],
                                C = f[10],
                            ...
                            var ab = f.length >= 6,
                                ...
                                db = f[2] || 0,
                                eb = ab ? f[3] : 1;
                            s.x = f[4] || 0, s.y = f[5] || 0, k = Math.sqrt(bb * bb + cb * cb), l = Math.sqrt(eb * eb + db * db), m = bb || cb ? Math.atan2(cb, bb) * H : s.rotation || 0, n = db || eb ? Math.atan2(db, eb) * H + m : s.skewX || 0, o = k - Math.abs(s.scaleX || 0), p = l - Math.abs(s.scaleY || 0), Math.abs(n) > 90 && 270 > Math.abs(n) && (t ? (k *= -1, n += 0 >= m ? 180 : -180, m += 0 >= m ? 180 : -180) : (l *= -1, n += 0 >= n ? 180 : -180)), q = (m - s.rotation) % 180, r = (n - s.skewX) % 180, (void 0 === s.skewX || o > u || -u > o || p > u || -u > p || q > -w && w > q && !1 | q * v || r > -w && w > r && !1 | r * v) && (s.scaleX = k, s.scaleY = l, s.rotation = m, s.skewX = n), wb && (s.rotationX = s.rotationY = s.z = 0, s.perspective = z, s.scaleZ = 1)
                        }
                        s.zOrigin = y;
                ...
                Ab = M.set3DTransformRatio = function(a) {
                    ...
                    l = 1, d = e = h = i = j = k = n = o = p = 0, q = J ? -1 / J : 0, r = z.zOrigin, s = 1e5, B = z.rotationY * G, B && (t = Math.cos(B), u = Math.sin(B), j = l * -u, o = q * -u, d = b * u, h = f * u, l *= t, q *= t, b *= t, f *= t), B = z.rotationX * G, B && (t = Math.cos(B), u = Math.sin(B), v = c * t + d * u, w = g * t + h * u, x = k * t + l * u, y = p * t + q * u, d = c * -u + d * t, h = g * -u + h * t, l = k * -u + l * t, q = p * -u + q * t, c = v, g = w, k = x, p = y), 1 !== E && (d *= E, h *= E, l *= E, q *= E), 1 !== D && (c *= D, g *= D, k *= D, p *= D), 1 !== C && (b *= C, f *= C, j *= C, o *= C), r && (n -= r, e = d * n, i = h * n, n = l * n + r), e = (v = (e += F) - (e |= 0)) ? (0 | v * s + (0 > v ? -.5 : .5)) / s + e : e, i = (v = (i += H) - (i |= 0)) ? (0 | v * s + (0 > v ? -.5 : .5)) / s + i : i, n = (v = (n += I) - (n |= 0)) ? (0 | v * s + (0 > v ? -.5 : .5)) / s + n : n, A[tb] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix3d(" : "matrix3d(") + [(0 | b * s) / s, (0 | f * s) / s, (0 | j * s) / s, (0 | o * s) / s, (0 | c * s) / s, (0 | g * s) / s, (0 | k * s) / s, (0 | p * s) / s, (0 | d * s) / s, (0 | h * s) / s, (0 | l * s) / s, (0 | q * s) / s, e, i, n, J ? 1 + -n / J : 1].join(",") + ")"
                },
                Bb = M.set2DTransformRatio = function(a) {
                    var b, c, d, e, f, g = this.data,
                        ...
                        j = g.x,
                        k = g.y;
                    return g.rotationX || g.rotationY || g.z || g.force3D === !0 || "auto" === g.force3D && 1 !== a && 0 !== a ? (this.setRatio = Ab, void Ab.call(this, a)) : void(g.rotation || g.skewX ? (b = g.rotation * G, c = b - g.skewX * G, d = 1e5, e = g.scaleX * d, f = g.scaleY * d, i[tb] = (g.xPercent || g.yPercent ? "translate(" + g.xPercent + "%," + g.yPercent + "%) matrix(" : "matrix(") + (0 | Math.cos(b) * e) / d + "," + (0 | Math.sin(b) * e) / d + "," + (0 | Math.sin(c) * -f) / d + "," + (0 | Math.cos(c) * f) / d + "," + j + "," + k + ")") : i[tb] = (g.xPercent || g.yPercent ? "translate(" + g.xPercent + "%," + g.yPercent + "%) matrix(" : "matrix(") + g.scaleX + ",0,0," + g.scaleY + "," + j + "," + k + ")")
                };
            ...
            var Fb = function(a) {
                if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) f.cssText = "", e = !0;
                        ...
                        for (b = this.e.split(","), d = b.length; --d > -1;) c = b[d], h[c] && (h[c].parse === g ? e = !0 : c = "transformOrigin" === c ? vb : h[c].p), Db(f, c);
            ...
            return g.cascadeTo = function(a, c, d) {
                ...
                for (a = h._targets || h.target, Hb(a, j, l), h.render(c, !0), Hb(a, k), h.render(0, !0), h._enabled(!0), e = l.length; --e > -1;)
