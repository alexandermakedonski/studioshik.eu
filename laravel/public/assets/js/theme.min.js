...
jQuery(document).ready(function(a) {
    function b() {
        ...
        }), a(".magnific-audio").each(function() {
            var b = a(this),
                c = a(this).attr("href");
            b.magnificPopup({
                items: {
                    src: '<audio controls="" preload="auto"><source src="' + c + '"></audio>',
                    type: "inline"
                },
                callbacks: {
                    open: function() {
    ...
    function c(b) {
        var c = a(b).closest("div.isotope"),
            ...
            p = d.attr("data-flex-itemwidth") ? parseInt(d.attr("data-flex-itemwidth"), 10) : 0,
            q = d.attr("data-flex-itemmax") ? parseInt(d.attr("data-flex-itemmax"), 0) : 0,
            r = d.attr("data-flex-itemmin") ? parseInt(d.attr("data-flex-itemmin"), 0) : 0,
            s = "top" === d.attr("data-flex-captionvertical") ? "flex-caption-top" : "",
            t = "alternate" === d.attr("data-flex-captionhorizontal") ? "flex-caption-alternate" : "flex-caption-" + d.attr("data-flex-captionhorizontal");
        d.addClass(n).addClass(o).addClass(k).addClass(l).addClass(t).addClass(s), d.flexslider({
            slideshow: e,
            animation: f,
            direction: h,
    ...
    /Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent || navigator.vendor || window.opera) ? (a('body:not([class*="oxy-agent-"])').addClass("oxy-agent-"), /iPhone/i.test(navigator.userAgent || navigator.vendor || window.opera) && a("body").not(".oxy-agent-iphone").addClass("oxy-agent-iphone"), /iPad/i.test(navigator.userAgent || navigator.vendor || window.opera) && a("body").not(".oxy-agent-ipad").addClass("oxy-agent-ipad")) : skrollr.init({
        forceHeight: !1
    }), b(), a(".flexslider[id]").filter(function() {
    ...
    g.on("click", "a", function() {
        ...
        return b.hasClass("selected") ? !1 : (c.find("a").removeClass("active"), b.addClass("active"), c.next().find(".isotope").addBack(".isotope").isotope({
    ...
    for (var h = document.getElementsByTagName("iframe"), i = 0; i < h.length; i++) h[i].src += -1 === h[i].src.indexOf("?") ? "?wmode=opaque" : "&wmode=opaque";
    a(".accordion-body").on("hide", function() {
        ...
        success: function(b, c, d) {
            a(b).parent().css("background-image", "url('" + a(b).attr("poster") + "')");
            var e = a(b).closest("section");
            b.addEventListener("loadeddata", function() {
                ...
                a(b).parent().css("padding-bottom", i), k >= c ? a(b).css("top", (c - g * j) / 2) : a(b).css("background-image", ""), a(b).show(), a(window).smartresize(function() {
                    c = e.outerHeight(), f = e.outerWidth(), j = f / h, k = g * j, k >= c ? a(b).css("top", (c - g * j) / 2) : a(b).css("background-image", "")
                })
            }), a('body:not([class*="oxy-agent-"])').length || a(b).show(), a("body").hasClass("oxy-agent-ipad") && e.on("click", function() {
    ...
    var j = a("#masthead"),
        k = a("#masthead").position();
    k = void 0 === k ? 0 : k.top;
    var l = a(".navbar").find("a"),
        m = l.map(function() {
            var b = this.hash;
    ...
    if (m.length) {
        ...
        a("body").find("section").each(function() {
            this.id && n.push(this)
        }), n.length && (l.parent().removeClass("active current-menu-item"), a.each(n, function(b, c) {
            var d = a(c);
            d.waypoint({
                offset: function() {
                    return e(d, "up", j)
    ...
    a(".navbar a, a.scroll-to-id").on("click", function(b) {
        var c = this.hash,
            d = 0;
        if (c && a(c).length) {
            b.preventDefault();
            ...
            if (void 0 !== j && j.hasClass("navbar-sticky") && e >= k + f) {
    ...
    var p = a(".navbar-sticky");
    p.waypoint("sticky", {
        stuckClass: "navbar-stuck"
    });
    var q = a("#masthead.navbar-sticky");
    if (q.length && q.hasClass("navbar-sticky")) {
        var r = q.position().top;
        a("body").waypoint({
            offset: -(parseInt(scriptData.navbarScrolledPoint) + r),
            handler: function() {
                q.toggleClass("navbar-scrolled"), q.one("MSTransitionEnd webkitTransitionEnd oTransitionEnd transitionend", function() {
                    q.hasClass("refreshing") || a.waypoints("refresh"), q.toggleClass("refreshing")
                })
            }
        })
    }
    ...
    s.length > 0 && s.infinitescroll({
        ...
        a(c).each(function(b, c) {
            if (a(c).find("article").hasClass("format-video") && a(c).find(".video-wrapper").fitVids(), a(c).find("article").hasClass("format-audio") && a(c).find("audio").mediaelementplayer(), a(c).hasClass("portfolio-item")) {
        ...
        }), s.isotope("insert", a(c), function() {
            s.isotope("reLayout"), b()
        })
    }), scriptData.hoverMenu.hoverActive === !0 && a(".navbar .dropdown").hover(function() {
    ...
    }), a("body").on("country_to_state_changed", function() {
