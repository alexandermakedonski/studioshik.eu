...
<body>
        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse main-navbar" role="navigation">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#contact" class="dropdown-toggle" >Контакти</a>
                    </li>
    ...
    <div id="content" role="main">
        <section id="contacts" class="section swatch-red-white">
        ...
        <section id="contact" class="section swatch-red-white has-top">
            <div  class="decor-top">
                <svg class="decor" height="100%" preserveaspectratio="none" version="1.1" viewbox="0 0 100 100" width="100%" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container">
                <header class="section-header underline">
                    <h1 class="headline super hairline">Контакти</h1>
                    <ul class="address">
                        <li>Адрес: бул. Александър Стамболийски №33</li>
                        <li>(на ъгъла с цар Самуил 50) 1303 София</li>
                    </ul>
                </header>
                <div class="container">
                <div class="row">
                    <div class="col-md-6 workTime">
                    <h3>Работно време</h3>
                    <ul>
                        <li>Понединик - Петък: 10:00 - 20:00 часа</li>
                        <li>Събота: 10:00 - 18:00 часа</li>
                    ...
                    <h3>Връзка с нас</h3>
                    <ul>
                        <li>Телефон: +359895740642</li>
                        <li>Телефон: 02 4198996</li>
                        <li>Имейл: contact@shik.bg</li>
                    </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <form id="contactForm" class="contact-form" action="/contacts" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                            <div class="form-group form-icon-group">
                                <input class="form-control" id="name" name="name" placeholder="Вашето име *" type="text" required=""><i class="fa fa-user"></i>
                            </div>
                            <div class="form-group form-icon-group">
                                <input class="form-control" id="email" name="email" placeholder="Вашият имейл *" type="email" required=""><i class="fa fa-envelope"></i>
                            </div>
                            <div class="form-group form-icon-group">
                                <textarea class="form-control" id="message" name="message" placeholder="Вашето съобщение" rows="10" required=""></textarea><i class="fa fa-pencil"></i>
                            </div>
                            <div class="form-group">
                                <button style="background-color: rgba(0, 0, 0, .0); margin-left:-5px;"><a class="btn btn-lg btn-info btn-icon-right">Изпрати имейл
                                     <span class="hex-alt hex-alt-big"><i class="fa fa-envelope" data-animation="pulse"></i></span>
                                </a>
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="col-md-6">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2932.3141724423967!2d23.317923999999998!3d42.697068!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40aa856bd8c4a7df%3A0xcbdbe915d8e3c20e!2z0KHRgtGD0LTQuNC-INC30LAg0LrRgNCw0YHQvtGC0LAg0KjQmNCa!5e0!3m2!1sbg!2sbg!4v1425389204363" width="600" height="353" frameborder="0" style="border:0"></iframe>
