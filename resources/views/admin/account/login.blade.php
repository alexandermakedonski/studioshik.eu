...
<head>
    ...
    <title>Студио ШИК администраторски панел</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Вписване</h3>
                    </div>
                        ...
                        <form  role="form" method="POST" action="/admin/login">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <input type="name" class="form-control" name="name" placeholder="Име *" type="text" autofocus value="{{ old('name') }}" >
                                </div>
                                <div class="form-group">
